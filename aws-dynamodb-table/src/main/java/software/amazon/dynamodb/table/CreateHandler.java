    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        return ProgressEvent.progress(model, callbackContext)
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-DynamoDB-Table::Create", proxyClient, model, callbackContext)
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-DynamoDB-Table::postCreate", proxyClient, model, callbackContext)
